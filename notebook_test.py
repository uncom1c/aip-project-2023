...
def decoder (key, lock):
    ...
    for i in range(len(decoded_stroka)//8):
        temp_stroka=''
        temp_stroka= decoded_stroka[i] + decoded_stroka[i+1] + decoded_stroka[i+2] + decoded_stroka[i+3] + decoded_stroka[i+4] 
        temp_stroka = temp_stroka + decoded_stroka[i+5] +  decoded_stroka[i+6] + decoded_stroka[i+7]
        num_letter=0
